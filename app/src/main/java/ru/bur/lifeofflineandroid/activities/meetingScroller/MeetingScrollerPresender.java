...
public class MeetingScrollerPresender {
    ...
    @Inject
    public MeetingScrollerPresender(Cookies cookies, ObjectBox objectBox) {
    ...
    public void getMeetingsFromDB(List<Meeting> meetings) {
        meetings.addAll(objectBox.getAll());
